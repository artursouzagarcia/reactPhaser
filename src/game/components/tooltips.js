...
export class PhaserTooltip {
    ...
    createBackground(container, content, x, y, width, height, options) {
        ...
        var rect = new Phaser.Geom.Rectangle(
            options.html === undefined ? -_width / 2 + container.width / 2 : -_width / 2,
            0,
            _width,
            _height,
        );
